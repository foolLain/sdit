...
def find_model(model_name):
    """
    Finds a pre-trained SDiT model, downloading it if necessary. Alternatively, loads a model from a local path.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-fid-samples", type=int, default=300)

    parser.add_argument("--image-size", type=int, choices=[32,64,128], default=32)
    parser.add_argument("--patch-size", type=int, choices=[2,4], default=2)
    ...
    parser.add_argument("--ckpt", type=str, default="./checkpoints/0050000.pt",
